...
public class SS_Starfield3DProcedural : SS_AGeneratorStarfield
{
	...
	[Range(0, 39)]
	public int detail = 4;
	public float scrollSpeed = 1000000;
	...
	private Vector4 scrollOffset = Vector4.zero;
	private Vector4 offset1, offset2, offset3; // Add these at class level
	private Vector4 scroll = Vector4.zero;
	...
	void Update()
	{
		...
		scroll.z += scrollSpeed * Time.deltaTime;

		scrollZ += Time.deltaTime * scrollSpeed;
		ValidatedMaterial().SetVector("_Scroll", new Vector4(0f, 0f, scrollZ, 0f));
	}
